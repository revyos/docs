...
Lichee Pi 4A 是 Sipeed 使用 TH1520 芯片推出的开发板，基本开发板开箱配置可以参考官网中的[开发板硬件配置](https://wiki.sipeed.com/hardware/zh/lichee/th1520/lpi4a/2_unbox.html)。开发板的操作系统选择 [RevyOS 20250729 版本](https://fast-mirror.isrc.ac.cn/revyos/extra/images/lpi4a/20250729/)。你可以在[镜像刷写教程](../../../Installation/intro)模块查看如何将 RevyOS 刷写进系统。
