---
title: Inceptionv3
description: 在 RevyOS 系统上运行 Inceptionv3 模型的教程
sidebar_position: 11
---
...
本教程将引导你如何通过 CPU 或 NPU 在 RevyOS 系统上运行 Inceptionv3 模型。Inceptionv3 是一种多分支卷积神经网络，能高效提取多尺度特征，用于图像分类任务。
...
我们使用的模型来自 [tensorflow 模型仓库](https://github.com/tensorflow/models/tree/master/research/slim)，可以通过以下命令下载 Inceptionv3 模型：
...
在 `classification/inceptionv3` 目录下，使用以下命令编译应用程序：
