...
| Lichee Cluster 4A                   | {<DownloadLink device="Lichee Cluster 4A" />} | 支持       |
| Lichee Console 4A                   | {<DownloadLink device="Lichee Console 4A" />} | 支持       |
| Lichee Book 4A                      | {<DownloadLink device="Lichee Book 4A" />}    | 支持       |
| Milk-V Pioneer / Sophgo EVB V1/V2   | {<DownloadLink device="Milk-V Pioneer" />}    | 支持       |
...
被弃用。请等待后续更新。（[追踪链接 #124](https://github.com/revyos/revyos/issues/124)）
:::
